<template>
  <header
    class="h-14 border-b border-[#2a2a2a] dark:border-[#333333] bg-[#1a1a1a] dark:bg-[#121212] flex items-center px-4 justify-between pixel-border-bottom">
    ...
    <div class="flex items-center gap-3">
      ...
      <button class="w-8 h-8 bg-transparent hover:bg-gray-800 rounded-none pixel-button-sm" @click="toggleTheme">
